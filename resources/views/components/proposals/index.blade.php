<x-ui.card>
	...
	<div class="py-4">
		...
		@if ($proposals->hasMorePages())
			<div class="mt-6">
				<button wire:click="loadMore" class="bg-[#181826] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px] hover:bg-[#373751] transition duration-300 ease-in-out w-full">Carregar Mais</button>
			</div>
		@endif
	</div>
